  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.black_color1 }}>
      ...
      <View style={{ width: '90%', alignSelf: 'center', marginTop: 15 }}>
        ...
        <View style={{ width: width * 0.9, height: 50, borderRadius: 15, overflow: 'hidden', marginBottom: 20 }}>
          <Picker
            selectedValue={marriedValue}
            themeVariant="dark"
            onValueChange={(itemValue, itemIndex) => {
              setMarriedValue(itemValue);
            }}
            style={{ padding: 0, marginBottom: 30, backgroundColor: colors.black_color4, }}>
            {
