...
const Otp = props => {
  ...
  useEffect(() => {
    ...
    Alert.alert(`${props.route.params?.otp}`)
    ...
    if (otp == value) {
      ...
      await axios({
        ...
        .then(async res => {
          ...
          console.log("Console. iya hai", res.data.id)
          console.log(res.data?.is_new_user == '0')
  ...
  const create_user_firebase_accout = async id => {
    await auth()
      ...
      .then(response => {
        props.dispatch(CustomerActions.setFirebaseId(response.user.id));
        database()
          .ref(`/UserId/${id}`)
      ...
      [ZIM, ZPNs],
      {
        ...
        requireConfig: data => {
          ...
          return {
            ...
            innerText: {
              incomingVideoCallDialogTitle: 'AstroKing',
              incomingVoiceCallPageMessage: 'AstroKing',
              incomingVoiceCallDialogMessage: 'AstroKing',
          ...
          <ScrollView style={{ flex: 0 }} showsVerticalScrollIndicator={false}>
            <View
              ...
              <Image
                ...
                style={{ width: width * 0.3, height: width * 0.4, resizeMode: 'contain' }}
              />
              <KeyboardAvoidingView
                behavior={Platform.OS == 'ios' ? 'padding' : 'height'}
                style={{
                ...
                <View
                  ...
                  <View
                    ...
                    <Text
                      ...
                      Enter the OTP to verify and update your mobile Number we
                      have sent OTP on
                    </Text>
