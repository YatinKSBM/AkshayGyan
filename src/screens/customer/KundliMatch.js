...
const KundliMatch = props => {
  ...
  const share_matching = async () => {
    ...
    ref.current.capture().then(uri => {
      ...
      let options = {
        title:
          'Checkout the AstroKing marriage compatibility report for Ranjeet and xxx.',
        url: uri,
      };
      Share.open(options)
        .then(res => {
        ...
        <View style={{ width: '95%', alignSelf: 'center', marginTop: 50 }}>
          ...
          <View style={{ ...styles.containerBox, backgroundColor: '#deab90' }}>
            <View style={styles.childContainerBox}>
              <Text style={styles.heading}>Compatibility (Varna)</Text>
              <Text style={styles.description}>
                Maitri refers to the mental compatibility of the two persons
                involved. It holds nominal effects in the matters of marriage
                compatibility.
              </Text>
            </View>
          ...
          <View style={{ ...styles.containerBox, backgroundColor: '#ffb3c1' }}>
            <View style={styles.childContainerBox}>
              <Text style={styles.heading}>Love (Bhakoot)</Text>
              <Text style={styles.description}>
                Maitri refers to the mental compatibility of the two persons
                involved. It holds nominal effects in the matters of marriage
                compatibility.
          ...
          <View style={{ ...styles.containerBox, backgroundColor: '#cfe1b9' }}>
            <View style={styles.childContainerBox}>
              <Text style={styles.heading}>Mental Compatibility (Maitri)</Text>
              <Text style={styles.description}>
                Maitri refers to the mental compatibility of the two persons
                involved. It holds nominal effects in the matters of marriage
                compatibility.
          ...
          <View style={{ ...styles.containerBox, backgroundColor: '#d7e3fc' }}>
            <View style={styles.childContainerBox}>
              <Text style={styles.heading}>Health (Nadi)</Text>
              <Text style={styles.description}>
                Maitri refers to the mental compatibility of the two persons
                involved. It holds nominal effects in the matters of marriage
                compatibility.
          ...
          <View style={{ ...styles.containerBox, backgroundColor: '#fbc3bc' }}>
            <View style={styles.childContainerBox}>
              <Text style={styles.heading}>Dominance (Vashya)</Text>
              <Text style={styles.description}>
                Maitri refers to the mental compatibility of the two persons
                involved. It holds nominal effects in the matters of marriage
                compatibility.
          ...
          <View style={{ ...styles.containerBox, backgroundColor: '#b7efc5' }}>
            <View style={styles.childContainerBox}>
              <Text style={styles.heading}>Temperament (Gana)</Text>
              <Text style={styles.description}>
                Maitri refers to the mental compatibility of the two persons
                involved. It holds nominal effects in the matters of marriage
                compatibility.
          ...
          <View style={{ ...styles.containerBox, backgroundColor: '#fffae5' }}>
            <View style={styles.childContainerBox}>
              <Text style={styles.heading}>Destiny (Tara)</Text>
              <Text style={styles.description}>
                Maitri refers to the mental compatibility of the two persons
                involved. It holds nominal effects in the matters of marriage
                compatibility.
          ...
          <View style={{ ...styles.containerBox, backgroundColor: '#f1a7a9' }}>
            <View style={styles.childContainerBox}>
              <Text style={styles.heading}>Physical Compatibility (Yoni)</Text>
              <Text style={styles.description}>
                Maitri refers to the mental compatibility of the two persons
                involved. It holds nominal effects in the matters of marriage
                compatibility.
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => props.navigation.navigate('astrologerList')}
              style={{
                flex: 0,
